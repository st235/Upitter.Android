...
public class QuizRecyclerAdapter extends RecyclerView.Adapter<QuizRecyclerAdapter.QuizViewHolder> {
    ...
    public QuizRecyclerAdapter(Resources resources, OnQuizChangeListener listener) {
    ...
    public QuizRecyclerAdapter(Resources resources, ArrayList<String> quizList, OnQuizChangeListener listener) {
        this.listener = listener;
    ...
    public class QuizViewHolder extends RecyclerView.ViewHolder {
        ...
        public QuizViewHolder(View itemView) {
            ...
            inputEditText = (MaterialEditText) itemView.findViewById(R.id.quiz_input);
            button = (ImageButton) itemView.findViewById(R.id.quiz_delete);
    ...
    public QuizViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.quiz_single_view, parent, false);
