...
public class AppInfoWhiteActivity extends BaseActivity implements ApplicationInfoQueryService.OnInfoListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_info_white);
    }
